---
name: sales-icp
description: Constroi ou refina o Perfil de Cliente Ideal (ICP) a partir de clientes atuais, produto e mercado. Use para 'quem e meu cliente ideal' ou antes de montar lista de prospeccao.
license: MIT
---
