---
name: sales
description: Orquestrador do time de vendas AI. Use quando o usuario pedir para prospectar empresas, rodar o ciclo de vendas completo, ou nao souber qual skill de vendas usar. Roteia para as skills sales-* corretas.
license: MIT
---
