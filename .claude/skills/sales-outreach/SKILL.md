---
name: sales-outreach
description: Gera sequencia de cold outreach personalizada (e-mails + toques de LinkedIn) baseada em pesquisa real do prospect e gatilhos recentes. Use para 'escreve o e-mail de abordagem' ou 'monta a cadencia'.
license: MIT
---
